...
# changelog: 1.0.6 change-log: Changelog added, module auto-update function reworked (requires complete re-download of the module to apply) added _cls_doc.
...
class UrlScanMod(loader.Module):
    ...
    async def check_for_updates(self):
        ...
        metadata_url = "https://raw.githubusercontent.com/Walidname113/KModules/heroku/URL-Scanner.py"
